...
⚠️ bypassPermissions는 AI가 마음대로 파일을 수정합니다. Git을 쓰면 언제든 되돌릴 수 있으니 안전합니다. Git 사용법은 [Git 기초](05-git-workflow.md)을 참고하세요.
...
상세 설명은 [처음 시작하기](00-quickstart.md)을 참고하세요.
...
- ✅ 느려지면 `/compact` ([처음 시작하기](00-quickstart.md))
